        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex gap-3">
              <a 
                ...
                className="w-9 h-9 rounded-lg bg-secondary flex items-center justify-center hover:bg-primary/20 transition-colors duration-300"
              >
          ...
          <div>
            ...
            <div className="space-y-3">
              <a 
                href="mailto:hello@calltoactions.dev" 
